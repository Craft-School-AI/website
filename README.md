# Craft-School.ai — сайт цифровой мастерской
...
| `NEXT_PUBLIC_SITE_URL` | нет | Публичный URL сайта для SEO/OG (по умолчанию `https://craft-school.ai`) |
...
3. В **Settings → Environment Variables** добавьте:
   - `TELEGRAM_BOT_TOKEN`
   - `TELEGRAM_CHAT_ID`
   - `NEXT_PUBLIC_SITE_URL` — боевой адрес сайта, например `https://craft-school.ai`
4. Нажмите **Deploy**.
